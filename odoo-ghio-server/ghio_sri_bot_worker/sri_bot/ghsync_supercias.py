...
from . import pages
from .pages.supercias import SearchPage, InformationSupercias
import json
...
class GHSyncSupercias:
    def __init__(
        ...
        # Paths
        self._home_path = os.path.join(home_path, 'supercias')
        ...
        # State
        self._action = const.ACTION_SUPERCIA_SEARCH
        ...
        self._url = "https://appscvsgen.supercias.gob.ec/consultaCompanias/societario/busquedaCompanias.jsf"
